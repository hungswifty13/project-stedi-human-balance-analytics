...
CustomerTrustedZone_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://hungdm-storage/customer/trusted/"],
        "recurse": True,
    },
...
DropDuplicates_node1678770208686 = DynamicFrame.fromDF(
    DropFields_node1678765893896.toDF().dropDuplicates(),
    glueContext,
    "DropDuplicates_node1678770208686",
)

# Script generated for node Accelerometer Trusted
AccelerometerTrusted_node3 = glueContext.write_dynamic_frame.from_options(
    frame=DropDuplicates_node1678770208686,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://hungdm-storage/accelerometer/trusted/",
        "partitionKeys": [],
    },
